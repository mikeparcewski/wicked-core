...
### Added
- **core-ts 0.7.16** — run-provenance env: wicked-core stamps WICKED_RUN_ID/UNIT/AGENT into the worker's estate-mcp launch env (both carriers) so proposal.submit (DES-MEM-FACETED-001) attributes proposals to the run/unit/agent.

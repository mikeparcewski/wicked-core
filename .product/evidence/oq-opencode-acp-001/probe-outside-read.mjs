...
// OQ-OPENCODE-ACP-001 probe: does a READ of a path OUTSIDE the session cwd escalate to a
// blocking session/request_permission (external_directory gating), given the plain "read
// seed.txt in cwd" case in capture-allow.ndjson never did (under the default, no-project-config
// invocation)?

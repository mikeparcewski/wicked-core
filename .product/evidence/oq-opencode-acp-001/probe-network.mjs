#!/usr/bin/env node
// OQ-OPENCODE-ACP-001 probe: a network action (curl), to see whether URL/network access
// escalates to a permission request under the default (no project permission config) invocation.

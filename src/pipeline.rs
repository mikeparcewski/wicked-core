...
pub(crate) fn pre_distribute(
    ...
    // Launcher-declared extra READ-ONLY roots (core#294), same launch-time validation and same
    // persistence rationale — a resume must not silently narrow (or widen) what the run may read.
